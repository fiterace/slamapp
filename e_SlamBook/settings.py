"""
Django settings for e_SlamBook project.
...
SECRET_KEY = 'd9)dhy6f!^w$74&0dp7pvtt(3gajj$^svlxxm&^mom5rbd^(3o'
...
WSGI_APPLICATION = 'e_SlamBook.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'users/db.sqlite3'), # change
    }
}
